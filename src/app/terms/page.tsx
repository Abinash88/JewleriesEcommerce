import MainTerms from '@/Components/PageComponent/FooterPages/MainTerms'
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const fetchData: SeoTypes = await fetchGetRequest({ endpoint: `seo/Terms` })
    return {
        ...
        principles of Social equity in health care. CMH is registered and established on 10th of Mangsir 2069 and is 
        thriving to provide health services in hygienic way as well as modernization in its system. The Hospital is 
        located presently in a centre of Pokhara, best suited for providing prompt health services.`,
