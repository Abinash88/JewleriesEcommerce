import MainServices from '@/Components/PageComponent/ServicesComponenet/MainServices'
...
export async function generateMetadata({ params }: { params: { id: string } }): Promise<Metadata> {
  ...
  return {
    title: fetchData?.meta_title || 'Services - Charak Memorial Hospital',
    //@ts-ignore
